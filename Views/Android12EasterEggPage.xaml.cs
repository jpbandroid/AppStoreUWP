...
{
    public sealed partial class Android12EasterEggPage : Page, INotifyPropertyChanged
    {
        ...
        public Android12EasterEggPage()
        {
            InitializeComponent();

            mpe.PosterSource = new BitmapImage(new Uri(DefaultPoster));
            mpe.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/a12eeonfire.mp4"));
        }
