...
{
    public sealed partial class Windows11WalkthroughPage : Page, INotifyPropertyChanged
    {
        ...
        public Windows11WalkthroughPage()
        {
            InitializeComponent();

            mpe.PosterSource = new BitmapImage(new Uri(DefaultPoster));
            mpe.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/Windows11_22463walk.mp4"));
        }
