...
{
    public sealed partial class AndroidEasterEggsPage : Page, INotifyPropertyChanged
    {
        ...
        public AndroidEasterEggsPage()
        {
            InitializeComponent();

            mpe.PosterSource = new BitmapImage(new Uri(DefaultPoster));
            mpe.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/EasterEggs.mp4"));
        }
