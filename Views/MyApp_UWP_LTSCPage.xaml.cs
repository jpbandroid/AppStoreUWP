...
namespace AppStore.Views
{
    public sealed partial class MyApp_UWP_LTSCPage : Page, INotifyPropertyChanged
    {
        ...
        private async void download(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            try
            {
                var myappuri = new Uri("https://occoam.com/jpb/wp-content/uploads/MyAppUWP1.3.zip");
                ...
                if (folder != null)
                {
                    StorageFile testfile = await folder.CreateFileAsync("MyAppUWPLTSC.zip", CreationCollisionOption.ReplaceExisting);
            ...
            new ToastContentBuilder()
                ...
                .AddText("MyApp UWP LTSC download complete")
                .AddText("Take a look!")
